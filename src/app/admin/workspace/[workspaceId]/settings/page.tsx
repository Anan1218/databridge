          ...
          {workspace && (
            <div className="grid grid-cols-4 gap-4 px-6 py-4 items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-gray-900">{workspace.ownerName}</div>
                  <div className="text-sm text-gray-500">Member since January 26, 2025</div>
                </div>
              </div>
              <div>
              ...
              <div className="text-gray-500">{workspace.ownerEmail}</div>
            </div>
          )}
        </div>
      </div>
